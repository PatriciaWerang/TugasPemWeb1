...
<script>
    ...
    document.getElementById('welcomeMessage').innerText = 'selamat datang' + localStorage.getItem('nama') +'dashboard';
        ...
        function fetchData(tahun) {
            ...
            return axios({
                method: 'post',
                url:'https://tugaswebpatricia.000webhostapp.com/sum_beritatahun.php',
                data: formData, 
...
.catch(error => {
    ...
    function populateSelectOption(data) {
        ...
        codocument.getElementById('tahunSelect').value = lastYear;
    ...
    axios.get('https://tugaswebpatricia.000webhostapp.com/select_tahun.php')
    .then(response => {
    ...
    axios.get('https://tugaswebpatricia.000webhostapp.com/sum_berita.php')
