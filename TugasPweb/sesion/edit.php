...
<div class="form-group">
            ...
            <input class="form-control" id="deskripsi"  name="deskripsi" required></tetxarea>
</div>
...
<script>
    function getData(){
        ...
        axios.post('https://tugaswebpatricia.000webhostapp.com/selectdata.php',formData )
...
axios.post('https://tugaswebpatricia.000webhostapp.com/editnews.php', formData,{
    headers: {
